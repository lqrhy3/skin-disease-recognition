...
def main(raw_data_dir: str, baked_data_dir: str):
    ...
    make_json_annotation(raw_data_dir, baked_data_dir)
...
def make_json_annotation(raw_data_dir: str, baked_data_dir: str):
    ...
    path_to_baked_ann_file = os.path.join(
        baked_data_dir, 'annotations.json'
    )
    write_json(annotations, path_to_baked_ann_file)
